...
В папке `docs` находится дополнительная документация проекта:

* `project_deployment.md` — инструкция по запуску и развёртыванию проекта;
* `Optimization_and_security.md` — описание мер по обеспечению безопасности и оптимизации приложения;
* `testing_report.md` — отчёт о проведённом тестировании системы.
